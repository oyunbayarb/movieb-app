...
import { OneMovieCard } from "./MovieCardComponent";
  ...
  return (
    <div className="w-full flex-col">
      ...
      <div className="flex flex-wrap gap-8">
        {TopratedMovieData.slice(0, 10).map((Element, index) => {
          return (
            <OneMovieCard
